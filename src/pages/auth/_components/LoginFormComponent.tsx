                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3 font-ubuntu">
                        ...
                        <div className="flex justify-between my-7 ">
                            ...
                            <Link to="/auth/signup">
                                <p className="text-gray-400 text-sm">Create an account <span className="text-blue-500 cursor-pointer">Sign Up</span></p>
                            </Link>
                        </div>
                        <div>
                            <Button type="submit" className="w-full h-[45px] cursor-pointer">Login</Button>
                        </div>
